      ...
      <br>
        ...
        <form action="Servlet_controlador" method="post">
            ...
            <table align="center" border="0" width="400">
                ...
                <tr>
                    <td>Stock: </td>
                    <td><input type="number" name="txtStock" value="<%=p.getStock()%>" min="1" max="500" required /></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><input type="submit" value="Actualizar" name="btnActualizar"/></td>
                </tr>
